...
const runTests = async () => {
  ...
  const cypressModulePath =
    __WEBPACK_EXTERNAL_createRequire(import.meta.url).resolve('cypress', { paths: [workingDirectory] }) ||
    'cypress'
  const cypress = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(cypressModulePath)
